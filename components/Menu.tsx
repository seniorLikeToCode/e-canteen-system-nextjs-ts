        ...
        <>
            <div className="flex gap-x-3 gap-y-1 mt-4">
                <motion.div
                    ...
                    className="inline-flex items-center  py-2 px-4 bg-slate-50 rounded-xl drop-shadow gap-x-1" >
                ...
                <motion.div
                    whileTap={{ scale: 0.8 }}
                    transition={{ type: "spring", stiffness: 400, damping: 17 }}
                    className="inline-flex items-center py-2 px-4 bg-slate-50 rounded-xl drop-shadow ">
